...
class guitar_xs_navwalker extends Walker_Nav_Menu {
        ...
        if (strcasecmp($item->attr_title, 'divider') == 0 && $depth === 1) {
            ...
            if (guitar_get_post_meta(guitar_main($item->object_id, false), 'hide_title_from_menu') != 'yes') {
                ...
                if ($args->has_children && $depth === 0) {
                    ...
                    if (!empty($item->url)) {
                        if ($section == 'on') {
                            $atts['href'] = esc_url($prefx . guitar_sectionID(guitar_main($item->object_id, false)));
                        } else {
