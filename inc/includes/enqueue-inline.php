...
function _action_xs_hook_css() {
    if (defined('FW')) {
        ...
        $hero_heading = guitar_get_option('general_posts_header');
        $hero_overlay = $hero_heading['header_overlay_color'];
        $blog_hero = $hero_heading['header_image'] != '' ? $hero_heading['header_image']['url'] : GUITAR_IMAGES . '/exman.jpg';
        ...
        $custom_css = guitar_get_option('custom_css');
