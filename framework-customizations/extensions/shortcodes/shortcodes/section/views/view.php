...
$section_image_style = $atts['section_image']['image_style'];
$section_image = $atts['section_image']['on']['image'];
$section_link = $atts['section_image']['on']['link'];
?>
<section  id="<?php echo $id; ?>" class="fw-main-row <?php echo esc_attr($section_extra_classes) ?> <?php echo $height_classes ?> <?php echo esc_attr($custom_class); ?>"  style="<?php echo $bg_color; ?> <?php echo $bg_image; ?> <?php echo $extra_height; ?>" <?php echo $bg_video_data_attr; ?> >
    ...
    <?php if ($section_image_style == 'on'): ?>
        <a href="#<?php echo esc_attr($section_link)?>" class="service_border_raund text-center">
            <img src="<?php echo esc_url($section_image['url'])?>" alt="" />
        </a>
    <?php endif; ?>
