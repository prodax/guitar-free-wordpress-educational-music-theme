                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="acc-heading-<?php echo $count; ?>">
                            <h4 class="panel-title">
                                <a <?php echo $collapsed; ?> data-toggle="collapse" data-parent="#<?php echo $id; ?>" href="#acc-tab-<?php echo $id . '-' . $count; ?>" aria-expanded="<?php echo $aria_expanded; ?>" aria-controls="acc-tab-<?php echo $id . '-' . $count; ?>"><?php echo $icon; ?> <?php echo guitar_theme_translate(esc_html($tab['title'])); ?></a>
                            </h4>
                        </div>
                        <div id="acc-tab-<?php echo $id . '-' . $count; ?>" class="panel-collapse collapse <?php echo $panel_class; ?>" role="tabpanel" aria-labelledby="acc-heading-<?php echo $count; ?>">
                            <div class="panel-body"><?php echo do_shortcode(guitar_theme_translate(esc_textarea($tab['content']))); ?></div>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
